...
Print files are not available yet. STL files, editable CAD files, print material and settings, and the screw thread and length still need to be added before others can reproduce the housing.
